        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 8, flexShrink: 0 }}>
          ...
          {!allDefaults && (
            <span
              ...
              style={{ fontSize: 10, fontWeight: 700, color: '#F0455A', cursor: 'pointer' }}
            >
              Clear
            </span>
          )}
          <i className="fa-solid fa-sliders" style={{ fontSize: 10, color: '#1B4332' }} />
          <span style={{ fontSize: 10, fontWeight: 700, color: '#1B4332' }}>Filters</span>
        </div>
      </div>
      ...
      {open && (
        <div style={{
          ...
          <div style={{ padding: '8px 12px', borderBottom: '1px solid #F4F6F0' }}>
            <div style={{ fontSize: 9, fontWeight: 700, textTransform: 'uppercase', letterSpacing: '0.8px', color: '#94a3b8', marginBottom: 6 }}>
              Sort
            </div>
